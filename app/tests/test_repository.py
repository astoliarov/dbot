...
class TestCaseRepository:
    ...
    async def test__save__state_and_key_passed_correctly(
        self,
        repository,
        redis_client
    ):
        ...
        redis_client.set.assert_called_once_with(
            "channel_v2_1",
            '{"id": 1, "ts": 100, "users": [{"username": "test", "id": 2}]}'
        )

    async def test__get__previous_state_and_users_exists__channel_built(
        self,
        repository,
        redis_client,
        discord_client
    ...
    async def test__get__previous_state_and_no_users__channel_is_none(
        self,
        repository,
        redis_client,
        discord_client
