...
from models import Notification, ChannelConfig, ChannelActivityNotification
...
class CallbackService:
    ...
    async def send_channel_activity_notification(self, notification: ChannelActivityNotification, channel_id: int) -> None:
